...
sr.reveal('.details__product', {origin : 'left', distance : '3%', reset : true});
sr.reveal('.details__ingredients', {origin : 'right', distance : '3%', delay : 200, reset : true});
sr.reveal('.cow__picture', {origin : 'left', distance : '3%', reset : true});
sr.reveal('.cow__presentation div', {origin : 'right', distance : '3%', delay : 200, reset : true});
sr.reveal('.recipe', {origin : 'bottom', duration : 1000, distance : '3%', reset : true});